...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-[#FFF5F5] via-[#FFF0EC] to-[#F7FCF9] relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 opacity-40 pointer-events-none bg-[radial-gradient(#7A0C1E_1px,transparent_1px)] [background-size:24px_24px]" />
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#7A0C1E]/20 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#5F0917]/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative w-full max-w-5xl bg-white/60 backdrop-blur-2xl rounded-3xl p-3 sm:p-5 shadow-2xl border border-white/80 shadow-rose-900/10 flex flex-col lg:flex-row items-stretch gap-6 overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 bg-white/90 backdrop-blur-md rounded-2xl p-7 sm:p-9 flex flex-col justify-between shadow-sm border border-[#E8DACD]">
          
          <div>
            {/* Top Logo */}
            <div className="flex items-center gap-2.5 mb-8">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-[#7A0C1E] to-[#5F0917] text-white flex items-center justify-center font-black text-sm shadow-md">
                FN
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 rounded-xl bg-[#7A0C1E] hover:bg-[#5F0917] active:scale-[0.99] text-[#2B1B17] font-extrabold text-sm shadow-lg shadow-red-900/20 transition-all cursor-pointer flex items-center justify-center gap-2 mt-2"
              >
                {isLoading ? (
                  <>
        ...
        <div className="hidden lg:flex w-1/2 relative bg-gradient-to-br from-[#FFF5F5] to-[#FFEBE3] rounded-2xl p-8 items-center justify-center overflow-hidden border border-white/60">
          ...
          {/* Glowing Backdrops */}
          <div className="absolute w-72 h-72 bg-[#7A0C1E]/30 rounded-full blur-3xl -top-10 -right-10" />
          <div className="absolute w-60 h-60 bg-[#5F0917]/30 rounded-full blur-3xl bottom-0 left-0" />

          {/* 3D Glass Shield Container */}
          <div className="relative z-10 flex flex-col items-center justify-center">
            
            {/* Curved Animated Ring */}
            <div className="absolute w-72 h-72 rounded-full border-4 border-[#7A0C1E]/40 border-t-[#7A0C1E] animate-spin [animation-duration:12s] pointer-events-none" />
            ...
            <div className="relative w-48 h-56 bg-white/40 backdrop-blur-xl rounded-3xl border-2 border-white/80 shadow-2xl flex flex-col items-center justify-center p-6 transform hover:rotate-2 transition-transform duration-500">
              ...
              <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#7A0C1E] to-[#5F0917] flex items-center justify-center text-[#2B1B17] shadow-xl shadow-red-900/30 mb-4 animate-bounce [animation-duration:3s]">
              ...
              <div className="bg-white rounded-2xl px-5 py-2 shadow-xl border border-[#E8DACD] flex items-center gap-2">
                <span className="text-xl font-black text-[#2B1B17] tracking-widest">* * *</span>
              </div>
            </div>

            {/* Wooden Pedestal Base Visual */}
            <div className="w-56 h-8 bg-gradient-to-r from-[#5F0917]/60 via-[#7A0C1E]/60 to-[#5F0917]/60 backdrop-blur-md rounded-2xl mt-4 shadow-lg border border-amber-500/20 transform rotate-1" />

            {/* Play overlay button */}
            <div className="absolute w-14 h-14 rounded-full bg-white/80 backdrop-blur-md shadow-xl flex items-center justify-center text-[#2B1B17] cursor-pointer hover:scale-110 transition-transform">
              <div className="w-0 h-0 border-y-8 border-y-transparent border-l-[14px] border-l-[#2B1B17] ml-1" />
            </div>
