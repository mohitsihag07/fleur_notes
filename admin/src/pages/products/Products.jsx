...
const Products = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 bg-white px-4 py-2.5 rounded-full border border-gray-100 shadow-sm">
            <FiBox className="w-4 h-4 text-[#FF9D9D]" />
            <span className="text-xs font-black text-gray-800">
              {totalItems} Products
            </span>
          </div>

          {/* Add Product Button -> Direct Navigation */}
          <button
      ...
      {/* Filter & Search Bar */}
      <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-4">
        {/* Search Input */}
                    ...
                    <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-4 px-6 font-bold text-gray-800">
                        {product.category?.name ? (
                          <span className="px-3 py-1 rounded-full bg-[#FAF5F7] text-gray-700 text-xs font-extrabold border border-gray-100">
                            {product.category.name}
                          </span>
                        ) : (
                      ...
                      {/* Clickable Status Badge (Direct Click Toggle) */}
                      <td className="py-4 px-6">
                        <button
