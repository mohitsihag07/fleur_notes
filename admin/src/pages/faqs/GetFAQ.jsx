      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider bg-[#EEF8CD] text-[#2D252E] flex items-center gap-1.5">
          ...
          {isActive ? (
            <span className="px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider bg-[#BBF1D2]/60 text-[#1E7741] flex items-center gap-1.5">
        ...
        <div className="space-y-2">
          ...
          <div className="p-6 rounded-2xl bg-[#FAF5F7] border border-gray-100 text-sm font-semibold text-gray-800 leading-relaxed whitespace-pre-line">
            {faq.answer}
          </div>
        </div>

        {/* Footer Dates */}
        <div className="pt-4 border-t border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between text-xs font-bold text-gray-400 gap-2">
